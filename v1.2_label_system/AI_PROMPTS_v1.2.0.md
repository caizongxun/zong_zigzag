...
**GitHub 倉庫:** [https://github.com/caizongxun/zong_zigzag](https://github.com/caizongxun/zong_zigzag)
...
專案倉庫: [https://github.com/caizongxun/zong_zigzag](https://github.com/caizongxun/zong_zigzag) (分支: v1.2-label-system)
...
```
[https://github.com/caizongxun/zong_zigzag](https://github.com/caizongxun/zong_zigzag)
└── v1.2_label_system/
    ├── config.yaml                      # 配置 (推薦參數)
    ├── feature_engineering.py           # 特徵工程
